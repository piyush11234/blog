...
const TotalProperty = () => {
  ...
  const getTotalComments = async () => {
    try {
      const res = await axios.get(`https://blog-dqxu.onrender.com/api/comment/my-blogs/comments`, { withCredentials: true })
      if (res.data.success) {
  ...
  const getTotalLikes = async () => {
    try {
      const res = await axios.get(`https://blog-dqxu.onrender.com/api/blog/my-blog-likes`, { withCredentials: true })
      if (res.data.success) {
